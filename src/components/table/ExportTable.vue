...
<script>
import { Row, Col, Card, Icon, Button, Input, InputNumber, Table } from 'iview'
import {table2csvData, csvColumns} from './data/table2csv.js'
import {table2excelData, excelColumns} from './data/table2excel.js'
import table2excel from '@/assets/libs/table2excel.js'
export default {
  name: 'exportable-table',
  components: { Row, Col, Card, Icon, Button, Input, InputNumber, Table },
  data () {
    return {
...
<style lang="less" scoped>
  ...
  .exportable-table-download-con1[data-v-2fc2af39]{
    padding-top: 0;
  }
  .ivu-btn-primary{
    margin-top: 10px;
